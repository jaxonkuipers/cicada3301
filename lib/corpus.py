...
# rounds; communications.csv now pins observed order and stage separately from
...
EXPECTED_CORPUS_SHA = "fd22de159d070abd9d47cff8cff42ce544dec9abd157a046beb36058355f0499"
...
def corpus_sha256() -> str:
    ...
    not parsed. The 2012 Mabinogion and reference/english feed lib.fitness and
    are covered by `fitness.training_sha256()` instead.
    """
    h = hashlib.sha256()
    files = [
        COMMUNICATIONS_INDEX,
