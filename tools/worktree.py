"""Create and publish isolated solver wakes.
    ...
    python3 -m tools.worktree create cicada-1
    python3 -m tools.worktree publish
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(prog="python3 -m tools.worktree")
    ...
    try:
        if args.command == "create":
            ...
            print("publish committed checkpoints with: python3 -m tools.worktree publish")
        else:
