...
**Dependencies consumed.** R14.7 supplies Liber Primus; R12.2 supplies Cicada's established OpenPGP identity.
...
**State handed forward.** Liber Primus remains the active public route surface, with authored roles for its words, meaning and numbers and no selected representation or operation.

**Evidence.** Exact bytes: [`2016-01-liber-primus.asc`](../2016/communications/2016-01-liber-primus.asc).
