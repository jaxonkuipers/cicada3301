...
**Dependencies consumed.** R14.5 supplies onion 6 and the three OpenPuff-extracted magic squares.
...
**State handed forward.** A successful recipient holds the complete introduction, private endpoint/keypair and authenticated common onion-7 locator consumed by R14.7; the rest of the callback state is missing.

**Evidence.** The four signed hidden-service instructions, signed form and signed locator are communication records 29–34 in [`corpus/communications.csv`](../communications.csv).
