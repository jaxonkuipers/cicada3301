...
**Resulting state.** The solver held a 29-row rune alphabet, transliterations, values and prime ordering: [`corpus/2013/gematria-primus/`](../2013/gematria-primus/).
...
**Evidence.** The reconstructed scan and machine-readable table are under [`corpus/2013/gematria-primus/`](../2013/gematria-primus/). The scan prints `U`; the machine table's U/V alias is a transcription convention.
