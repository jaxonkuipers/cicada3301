...
**Dependencies consumed.** R12.1 supplies the 509×503 carrier dimensions; R12.2 supplies the telephone number and recording endpoint.
...
**State handed forward.** `845145127.com`, `cicada.jpg` and the signed 9 January time gate pass to R12.4.

**Evidence.** The signed time gate is [`2012-01-patience-check-back.asc`](../2012/communications/2012-01-patience-check-back.asc). The literal phone instruction and carrier dimensions fix the arithmetic domain derivation.
