...
**Evidence.** The instruction's line protocol and reported signature status survive through recipient reconstruction; its exact signed bytes are absent locally. A [December 2013 mirror of the reported server implementation](https://gist.github.com/navinpai/7837596) preserves the command grammar as a contemporary secondary source. The callback body survives through an unauthenticated reported server log.
