...
**Evidence.** Exact signed public-route messages through R13.4 are under [`corpus/2013/communications/`](../2013/communications/). The poster calls, local shares, shared-onion welcome and question service survive through contemporary reconstruction and a [retrospective solve record](https://connortumbleson.com/2021/01/25/the-cicada-3301-mystery-puzzle-2/); their carrier bytes are absent locally.
