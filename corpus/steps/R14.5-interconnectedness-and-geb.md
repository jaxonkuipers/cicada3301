...
**Dependencies consumed.** R14.4 supplies onion 5; R12.1 establishes OutGuess as an authored carrier operation.
...
**State handed forward.** Onion 6 and the three magic squares pass to R14.6.

**Evidence.** The signed source stages are [`Interconnectedness hex`](../2014/communications/2014-01-interconnectedness-hex.asc) and [`onion-5 Liber Primus carrier`](../2014/communications/2014-01-onion5-liber-primus.asc).
