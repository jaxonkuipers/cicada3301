...
**Evidence.** The signed carriers are [`opening book code`](../2014/communications/2014-01-opening-book-code.asc) and [`RSA challenge`](../2014/communications/2014-01-rsa-oaep-challenge.asc).
