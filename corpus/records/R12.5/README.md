...
An enrolled solver reached a one-display page at their private R12.4 path. Recipient material describes a unique low-bit RSA modulus and `Crypt::RSA` 1.99 OAEP ciphertext for each solver. The retained instance uses `e=65537`, a 372-bit modulus and four 47-byte ciphertext blocks. Factoring it and reproducing the legacy OAEP convention yields `33521494043430258676`; returning that value reportedly produced “Correct. We'll email you.” Sharing individualized material triggered the preserved signed [removal message](artifacts/communications/2012-01-sharing-disqualification.asc).
