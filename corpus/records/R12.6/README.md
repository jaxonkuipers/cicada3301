...
**Evidence.** The whitespace number list is [`2012-01-location-numbers.asc`](artifacts/communications/2012-01-location-numbers.asc); the authenticated Blake carrier is [`2012-01-second-chance.asc`](artifacts/communications/2012-01-second-chance.asc).
