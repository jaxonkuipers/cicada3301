...
**Evidence.** The signed book code is [`2013-01-opening-book-code.asc`](artifacts/communications/2013-01-opening-book-code.asc); the surviving signed Cicada OS message is [`2013-01-cicada-os-message.asc`](artifacts/communications/2013-01-cicada-os-message.asc).
