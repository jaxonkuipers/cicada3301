...
**Evidence.** The exact signed coordinate, book-code and enrollment messages are [`coordinates`](artifacts/communications/2012-01-coordinates.asc), [`Agrippa route`](artifacts/communications/2012-01-book-code-poem.asc), [`twenty-nine volumes route`](artifacts/communications/2012-01-twenty-nine-volumes-book-code.asc) and [`enrollment`](artifacts/communications/2012-01-anonymous-email-enrollment.asc).
